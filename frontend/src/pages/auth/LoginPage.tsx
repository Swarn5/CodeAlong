...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex-1">
      <div className=" bg-purple-900  bg-gradient-to-b from-gray-900 via-gray-900 to-purple-800 h-full w-full min-h-screen sm:flex sm:flex-row justify-center bg-transparent shadow-xl">
        ...
        <div className="flex h-full justify-center self-center z-10 md:mr-0 lg:mr-5">
          <div className="p-12 pb-12 bg-white mx-auto rounded-3xl w-96 mt-14 md:mt-0 lg:mt-0">
            <div className="mb-7">
